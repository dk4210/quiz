        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <button v-if="questionIndex>0" class="btn btn-success float-right" @click="prev()">Previous</button>
                    <button class="btn btn-success" @click="next(); postuserChoice()">Next Question</button>
                    </div>
